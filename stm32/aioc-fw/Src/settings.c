...
void Settings_Default(void)
{
    ...
    /* Audio settings registers */
    settingsRegMap[SETTINGS_REG_AUDIO_RX] = SETTINGS_REG_AUDIO_RX_DEFAULT;
    settingsRegMap[SETTINGS_REG_AUDIO_TX] = SETTINGS_REG_AUDIO_TX_DEFAULT;
    ...
    /* Fox Hunt registers */
    settingsRegMap[SETTINGS_REG_FOX_INTERVAL] = SETTINGS_REG_FOX_INTERVAL_DEFAULT;
    settingsRegMap[SETTINGS_REG_FOX_ID0] = SETTINGS_REG_FOX_ID0_DEFAULT;
    settingsRegMap[SETTINGS_REG_FOX_ID1] = SETTINGS_REG_FOX_ID1_DEFAULT;
    settingsRegMap[SETTINGS_REG_FOX_ID2] = SETTINGS_REG_FOX_ID2_DEFAULT;
    settingsRegMap[SETTINGS_REG_FOX_ID3] = SETTINGS_REG_FOX_ID3_DEFAULT;
