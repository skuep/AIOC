...
void Settings_Default(void)
{
    ...
    /* Fox Hunt registers */
    settingsRegMap[SETTINGS_REG_FOXHUNT_CTRL] = SETTINGS_REG_FOXHUNT_CTRL_DEFAULT;
    settingsRegMap[SETTINGS_REG_FOXHUNT_MSG0] = SETTINGS_REG_FOXHUNT_MSG0_DEFAULT;
    settingsRegMap[SETTINGS_REG_FOXHUNT_MSG1] = SETTINGS_REG_FOXHUNT_MSG1_DEFAULT;
